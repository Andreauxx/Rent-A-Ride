...
#JEONANDREAUX BUSINESS BITCHHHHESSS
CustomerName = []
CustomerAge=[]
CustomerGender=[]
IDType=[]
...
def DisplayCars():
    table1 = Table(title="Car List",title_justify="center",width=235)
...
def DisplayCustomers():
    table = Table(title="Customer List",title_justify="center",width=230)
